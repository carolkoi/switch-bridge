...
@elseif(Auth::check() && auth()->user()->can('Can Update Transaction') OR ($req_field41 === "CASH" && $res_field48 === "AML-APPROVED") OR ($res_field48 === "UPLOAD-FAILED") OR  $res_field48 === "AML-LISTED")
