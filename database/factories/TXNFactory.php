...
$factory->define(TXN::class, function (Faker $faker) {
    ...
    return [
        ...
        'maker_checker_approve_status' => $faker->word,
        'maker_checker_reject_status' => $faker->word,
        'approved_at' => $faker->word,
        'rejected_at' => $faker->word
    ];
});
