...
use App\DataTables\Workflow\WorkflowStageTypesDataTable;
use App\Http\Requests\Workflow\CreateWorkflowStageTypesRequest;
use App\Http\Requests\Workflow\UpdateWorkflowStageTypesRequest;
...
class WorkflowStageTypesController extends AppBaseController
{
    ...
    {
        return $workflowStageTypesDataTable->render('workflow.workflow_stage_types.index');
    }
    ...
    {
        return view('workflow.workflow_stage_types.create');
    }
    ...
    public function store(CreateWorkflowStageTypesRequest $request)
    {
        ...
        return redirect(route('workflowStageTypes.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('workflow.workflow_stage_types.show')->with('workflowStageTypes', $workflowStageTypes);
    }
    ...
    public function edit($id)
    {
        ...
        return view('workflow.workflow_stage_types.edit')->with('workflowStageTypes', $workflowStageTypes);
    }
