...
use App\DataTables\Workflow\WorkflowStagesDataTable;
use App\Http\Requests\Workflow\CreateWorkflowStagesRequest;
...
use App\Repositories\Workflow\WorkflowStepRepository;
...
class WorkflowStagesController extends AppBaseController
{
    ...
    {
        return $workflowStagesDataTable->render('workflow.workflow_stages.index');
    }
    ...
    {
        return view('workflow.workflow_stages.create')
    ...
    public function show($id)
    {
        ...
        return view('workflow.workflow_stages.show')
    ...
    public function edit($id)
    {
        ...
        return view('workflow.workflow_stages.edit')->with('workflowStages', $workflowStages)
            ->withWorkFlowTypes($this->workflowTypesRepository->all(['name','id'])->pluck('name', 'id'))
            ->withWorkFlowStageTypes($this->stageTypesRepository->all(['name','id'])->pluck('name', 'id'));
    }
