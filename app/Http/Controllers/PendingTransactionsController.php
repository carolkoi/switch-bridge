...
//            }
            $data = Transactions::select()->transactionsByCompany()->orderBy('iso_id', 'desc')->WhereNotIn('res_field48', ['COMPLETED', 'FAILED']);
...
//                })
        ...
        return view('transactions.pending_index', ['partners' => $all_partners, 'upesi_partners' => $upesi_partners, 'txnTypes' => array_unique($txnTypes)]);
    }
